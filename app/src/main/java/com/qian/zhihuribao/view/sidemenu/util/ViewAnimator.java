...
import com.qian.zhihuribao.view.sidemenu.animation.FlipAnimation;
...
public class ViewAnimator<T extends Resourceble> {
    ...
    public void showMenuContent() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            int image = list.get(i).getImageRes();
            if (image > 0) {
                ((ImageView) viewMenu.findViewById(R.id.menu_item_image)).setImageResource(list.get(i).getImageRes());
            }
            ((TextView) viewMenu.findViewById(R.id.menu_item_title)).setText(list.get(i).getName());
