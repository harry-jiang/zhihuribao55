...
public class PagerIndicator extends LinearLayout implements ViewPager.OnPageChangeListener {
    ...
    public void destroySelf() {
        ...
        mAdapter.unregisterDataSetObserver(dataChangeObserver);
        removeAllViews();
    }
    ...
    public void setViewPager(ViewPager pager) {
        ...
        mAdapter = (SliderAdapter) pager.getAdapter();
        mPreviousSelectedPosition = mAdapter.getCurrentItem(pager.getCurrentItem()) - 1;
        mAdapter.registerDataSetObserver(dataChangeObserver);
    }
    ...
    public void onPageSelected(int position) {
        ...
        setItemAsSelected(mAdapter.getCurrentItem(position) - 1);
    }
